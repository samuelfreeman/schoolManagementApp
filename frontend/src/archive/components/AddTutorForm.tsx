import { tutorSignUpFormSchema as formSchema } from "@/archive/validation/Tutorschema";
...
import { loadTutors, tutorSignUp } from "@/archive/api/slices/tutorthunk";
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex  flex-col">
                ...
                <FormControl>
                  <Input placeholder="Firstname" {...field} className="h-7" />
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex  flex-col">
                ...
                <FormControl>
                  <Input placeholder="Lastname" {...field} className="h-7" />
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex    flex-col">
                ...
                <FormControl>
                  <Input placeholder="Password" {...field} className="h-7" />
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex  flex-col pb-3">
                <FormLabel className="text-sm">Registeration Code</FormLabel>
                <FormControl>
