...
import { loadStudentAnalytics } from "@/api/slices/studentThunk";
import {
    Card,
    CardContent,
    CardDescription,
...
export function StudentAnalyticsChart() {
    ...
    const chartData = React.useMemo(() => {
        ...
        return [
            ...
            { month: "female", count: analytics.female || 0, fill: "var(--color-female)" },
        ];
    }, [analytics]);
    ...
    const genders = React.useMemo(() => chartData.map((item) => item.month), [chartData]);
