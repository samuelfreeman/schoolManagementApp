...
import { z } from "zod"
import { otp as otpService } from "@/api/slices/adminthunk"
    ...
    return (
        <Form {...form}>
            <div className="bg-[url('/cool-background.svg')] w-full h-screen bg-cover  flex justify-center items-center bg-right-top">
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="bg-white rounded-md flex items-center flex-col justify-center  p-10">
